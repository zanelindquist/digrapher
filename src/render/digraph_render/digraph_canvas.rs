...
use crate::services::digraph_services::calculate_render::create_edges;
use crate::services::digraph_services::types::{
    CanvasPositioning, DrawObjectSelection, EdgeVector, ObjectSelection, PointInteraction,
    PointLabel, PointVector, Relation,
};
...
pub struct DigraphCanvasProps {
    ...
    pub edges: UseStateHandle<EdgeVector>,
    #[prop_or_default]
...
pub fn canvas(props: &DigraphCanvasProps) -> Html {
    ...
    let on_pointer_down = {
        ...
        Callback::from(move |e: PointerEvent| {
            ...
            for point in points.iter() {
                ...
                if point
                    .clone()
                    .pointer_by(x as f32, y as f32, radius, canvas_pos)
                {
                    ...
                    object_selection.set(ObjectSelection {
                        selection: Some(DrawObjectSelection::Point(point.label.clone())),
                    });
                }
            }
        })
    ...
    let on_pointer_move = {
        ...
        Callback::from(move |e: PointerEvent| {
            ...
            // Get logical coords
            let (offset_lx, offset_ly) =
                canvas_pos.pointer_to_logical_xy(offset_vx as f32, offset_vy as f32);
